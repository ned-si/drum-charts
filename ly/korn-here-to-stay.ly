...
\score {
  \new DrumStaff {
    ...
    \new DrumVoice = "all" {
      ...
      \repeat volta 3 {
        \drummode {
          <cymc bd hhp>8 hho <sn bd hhp> hho <bd hhp> <hho bd> <sn hhp>16 bd hho8
...
\score {
  \new DrumStaff {
    ...
    \new DrumVoice = "all" {
      ...
      \repeat volta 2 {
        \drummode {
          <cymc bd>8 cymc <cymc sn> cymc16 bd <cymc bd>8 cymc16 bd32 bd <cymc sn>16 bd cymc8
          ...
          \alternative {
            ...
            \volta 2 {
              <cymc sn>8 sn16:32_\right sn_\left sn_\right sn_\left tomh_\right hho_\left
            }
          }
        }
      }
    ...
    \new DrumVoice = "all" {
      ...
      \repeat volta 4 {
        \drummode {
          ...
          \alternative {
            \volta 1,3 {
              <cymc bd>8 cymc <cymc sn> cymc16 sn <cymc bd>8 <cymc bd> sn16 <cymc bd>8 <cymc bd>16
            }
            \volta 2 {
              <cymc bd>8 cymc <cymc sn> cymc16 sn <cymc bd>8 cymc16 bd \flam tomh
              tomfh tomfh
            }
            \volta 4 {
              bd8 \flam sn tomh16 tomh sn sn <toml hhp>8 <toml hhp> <tomfh hhp>16 tomfh <bd hhp> bd
            }
          }
        }
      }
    ...
    \new DrumVoice = "all" {
      ...
      \repeat volta 4 {
        \drummode {
          \alternative {
            \volta 1,2,3 {
              <cymc bd>8_\right hh16_\right hh_\left hh8_\right hh16:32_\right hh:32_\left hh8_\right hh16_\right hh_\left hh_\right hh_\left hh:32_\right hh:32_\left
...
\score {
  ...
  \new DrumStaff {
    ...
    \new DrumVoice = "all" {
      ...
      \repeat volta 4 {
        \drummode {
          <cymc bd>8 <cymc bd> <cymc sn>16 bd cymc bd <cymc bd>8 cymc <cymc sn> cymc 
    ...
    \new DrumVoice = "all" {
      ...
      \repeat volta 8 {
        \drummode {
          \alternative {
            \volta 1,5,7,8 {
              <cymc bd>4 <cymc sn>8 cymc <cymc bd> <cymc bd> <cymc sn>16 bd cymc8
            }
            \volta 2,3,6 {
              <cymc bd>8 cymc <cymc sn> cymc <cymc bd> <cymc bd> <cymc sn>16 bd cymc bd
            }
            \volta 4 {
...
\score {
  ...
  \new DrumStaff {
    ...
    \new DrumVoice = "all" {
      ...
      \repeat volta 8 {
        \drummode {
          <toml tomfh bd>8 <toml tomfh bd> \flam sn16 bd8 tomfh16 tomfh16 tomfh tomfh8. hhp4
          <toml tomfh bd>8 <toml tomfh> \flam sn16 bd8 <toml tomfh bd>16 <toml tomfh> <toml tomfh bd>8
            \alternative {
            \volta 1,2,3 {
              hhp4
            }
